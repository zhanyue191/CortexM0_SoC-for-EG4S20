...
set rc [catch {
  open_project {Cortex_M0.prj} -phy
  import_device eagle_s20.db -package EG4S20BG256
  import_db {../syn_1/Cortex_M0_gate.db}
  place
  export_db {Cortex_M0_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file Cortex_M0_phy.area
  export_db {Cortex_M0_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid Cortex_M0_inst.bid
  bitgen -bit "Cortex_M0.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
